 ...
 * @version Mayo de 2010 - Versión 1.0 (Beta)
 */
...
public class GraphicsConsole extends JFrame
{
    ...
    {
        super( "Consola Gráfica - Versión 1.0 (Beta)" );
    ...
    private void doHelp()
    {
        String cad = "GraphicsConsole - Versión 1.0 (Beta) - Mayo de 2010";
     ...
     * Los límites izquierdo y derecho del área rectangular a copia son (x) y 
     * (x + width) respectivamente. Los límites superior e inferior del rectángulo 
