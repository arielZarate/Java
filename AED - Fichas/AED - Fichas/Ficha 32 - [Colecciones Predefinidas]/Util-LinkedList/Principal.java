...
public class Principal
{
    public static void main(String args[])
    {
           ...
           System.out.println("Un LinkedList de estudiantes: ");
           System.out.println( v );
           
           Estudiante p = ( Estudiante ) v.get(3);  // recuperamos el estudiante de la casilla 3...
           System.out.println("El estudiante en la posición 3 era: " + p);
           
           // un ciclo para recorrer el LinkedList y contar cuantos tienen promedio >= 4
           int c = 0;
