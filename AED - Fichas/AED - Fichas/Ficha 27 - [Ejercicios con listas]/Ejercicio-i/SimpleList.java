...
public class SimpleList
{
       ...
       */
      public boolean contains (Envio x)
      {
      ...
      /**
       *  Inserta un Envio en forma ordenada en la lista. Se supone que la lista está ya ordenada 
       ...
       */
      public void addInOrder(Envio x)
      {
            if (x == null) return;
      ...
      /**
       * Busca un Envio x en la lista, y en caso de encontrarlo retorna una referencia al que estaba en la lista.
       * Retorna null si x no está en la lista. 
       * @param x el Envio a buscar.
       * @return una referencia al Envio que coincide con x, o null si x no existe en la lista.
       */
      public Envio search (Envio x)
      {
