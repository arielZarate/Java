...
public class SimpleList
{
       ...
       */
      public void addFirst(Paciente x)
      {
       ...
       */
      public boolean contains (Paciente x)//Busca el paciente por historia clinica
      {
       ...
       */
      public Paciente getFirst()//Devuelve el 1er paciente
      {
         Paciente x = null;
       ...
       */
      public void addInOrder(Paciente x)//Ordena la lista por historia clinica
      {
            if (x == null) return;
       ...
       *  @param x el valor a almacenar en la lista.
       */
      public void addLast(Paciente x)
      {
            if (x == null) return;
            Node nuevo = new Node( x, null );
            Node p = frente;
       ...
       */
      public Paciente search (Paciente x)
      {
