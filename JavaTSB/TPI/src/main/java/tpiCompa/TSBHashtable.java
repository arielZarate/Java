 ...
 * en forma nativa por Java.
 * Una TSBHashtable usa un arreglo de listas de la
...
public class TSBHashtable<K,V> implements Map<K,V>, Cloneable, Serializable
{
    ...
    private hashing.TSBArrayList<Map.Entry<K, V>> table[];
    ...
    public TSBHashtable(int initial_capacity, float load_factor)
    {
        ...
        this.table = new hashing.TSBArrayList[initial_capacity];
        for(int i=0; i<table.length; i++)
        {
            table[i] = new hashing.TSBArrayList<>();
        }
    ...
    public boolean contains(Object value)
    {
        ...
        for(hashing.TSBArrayList<Map.Entry<K, V>> bucket : this.table)
        {
    ...
    protected void rehash()
    {
        ...
        hashing.TSBArrayList<Map.Entry<K, V>> temp[] = new hashing.TSBArrayList[new_length];
        for(int j = 0; j < temp.length; j++) { temp[j] = new hashing.TSBArrayList<>(); }
    ...
    protected Object clone() throws CloneNotSupportedException 
    {
        ...
        t.table = new hashing.TSBArrayList[table.length];
        for (int i = table.length ; i-- > 0 ; ) 
        {
            t.table[i] = (hashing.TSBArrayList<Map.Entry<K, V>>) table[i].clone();
        }
        t.keySet = null;
        t.entrySet = null;
        t.values = null;
     ...
     * null.
     */
    private Map.Entry<K, V> search_for_entry(K key, hashing.TSBArrayList<Map.Entry<K, V>> bucket)
    {
        Iterator<Map.Entry<K, V>> it = bucket.iterator();
        while(it.hasNext())
        {
     ...
     */
    private int search_for_index(K key, hashing.TSBArrayList<Map.Entry<K, V>> bucket)
    {
        Iterator<Map.Entry<K, V>> it = bucket.iterator();
    ...
    public V get(Object key)
    {
        ...
        hashing.TSBArrayList<Map.Entry<K, V>> bucket = this.table[ib];
    ...
    public void clear()
    {
        this.table = new hashing.TSBArrayList[this.initial_capacity];
        for(int i = 0; i < this.table.length; i++)
        {
            this.table[i] = new hashing.TSBArrayList<>();
        }
        this.count = 0;
        this.modCount++;
    }
    ...
    private class KeySet extends AbstractSet<K> 
    {
        ...
        private class KeySetIterator implements Iterator<K>
        {
            ...
            public boolean hasNext() 
            {
                ...
                hashing.TSBArrayList<Map.Entry<K, V>> t[] = TSBHashtable.this.table;
            ...
            public K next() 
            {
                ...
                hashing.TSBArrayList<Map.Entry<K, V>> bucket = t[current_bucket];
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>> 
    {
        ...
        public boolean contains(Object o) 
        {
            ...
            hashing.TSBArrayList<Map.Entry<K, V>> bucket = TSBHashtable.this.table[index];
